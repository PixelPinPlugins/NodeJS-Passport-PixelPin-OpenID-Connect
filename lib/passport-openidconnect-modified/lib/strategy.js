  ...
  if (req.query && req.query.code) {
      ...
      oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', redirect_uri: callbackURL }, function(err, accessToken, refreshToken, params) {
        ...
        self._shouldLoadUserProfile(iss, sub, function(err, load) {
          ...
          if (load) {
            ...
            oauth2._request("GET", userInfoURL, { 'Authorization': "Bearer " + accessToken }, null, null, function (err, body, res) {
              ...
              try {
                ...
                {
                  //Unable To Fetch ID From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                ...
                {
                  //Unable To Fetch Email From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                ...
                {
                  //Unable To Fetch First Name From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                  profile.firstName = "Unavailable";
                }
                else
                {          
                  profile.firstName = json.given_name;          
                ...
                {
                  //Unable To Fetch Last Name From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                  profile.lastName = "Unavailable";
                }
                else
                {         
                  profile.lastName = json.family_name;            
                ...
                if(addressJson === undefined)
                {
                  ...
                  profile.gender = "Unavailable";
                  profile.dob = "Unavailable";
                  profile.country = "Unavailable";
                  profile.postal_code = "Unavailable";
                  profile.region = "Unavailable";
                  profile.locality = "Unavailable";
                  profile.street_address = "Unavailable";
                }
                else
                {
                  profile.street_address = addressJson.street_address;

                  if (profile.street_address === undefined || profile.street_address === null)
                  {
                    //Unable To Fetch Address 1 From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                    profile.street_address = "Unavailable";
                  }
                  else
                  {                 
                  ...
                  profile.locality = addressJson.locality;

                  if (profile.locality === undefined || profile.locality === null)
                  {
                    //Unable To Fetch Address 1 From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                    profile.locality = "Unavailable";
                  }
                  ...
                  profile.region = addressJson.region;
                  ...
                  profile.postal_code = addressJson.postal_code;

                  if (profile.postal_code === undefined || profile.postal_code === null)
                  {
                    //Unable To Fetch Address 1 From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                    profile.postal_code = "Unavailable";
                  }
                  ...
                  profile.country = addressJson.country;
                  ...
                  profile.dob = json.birthdate;

                  if (profile.dob === undefined || profile.dob === null)
                  {
                    //Unable To Fetch D.O.B. From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                    profile.dob = "Unavailable";
                  }
                  else
                  {        
                  ...
                  {
                    //Get User Data Error: Unable To Fetch Gender From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                    profile.gender = "Unavailable";
                  }
                  else
                  {         
                  ...
                  {
                    //Get User Data Error: Unable To Fetch Phone From Get User Data Endpoint Because the Data Is Undefined or Null. Which Means the User Data Endpoint Doesn't Contain This Type of Data.
                    profile.phone = "Unavailable";
                  }
                  else
                  {       
    ...
    this._setup(identifier, function(err, config) {
      ...
      function stored(err, state) {
        ...
        var authlocation = location.replace(/%20/gi,'+');
        self.redirect(authlocation);
      }
